...
(function (global, factory) {
    ...
    var Animate = {
        ...
        methods: {
            ...
            animate: function(action) {
                ...
                uikitUtil.css(this.target, 'minHeight', oldHeight);
                ...
                ).concat(uikitUtil.Transition.start(this.target, {minHeight: newHeight}, this.animation, 'ease'))).then(function () {
    ...
    UIkit.component('sortable', Component);
