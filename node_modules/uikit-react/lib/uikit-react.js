...
var Accordion = /** @class */ (function (_super) {
    ...
    Accordion.prototype.render = function () {
        return (React.createElement("ul", { className: setClassNames(this.props), "data-uk-accordion": this.props.options ? this.props.options : "" }, this.props.children));
    };
    return Accordion;
}(React.Component));
...
var AccordionItem = /** @class */ (function (_super) {
    ...
    AccordionItem.prototype.render = function () {
        return (React.createElement("li", null,
            React.createElement("a", { className: "uk-accordion-title", href: "#" }, this.props.title),
            React.createElement("div", { className: "uk-accordion-content" }, this.props.content)));
    };
...
var Icon = /** @class */ (function (_super) {
    ...
    Icon.prototype.renderIconType = function () {
        if (this.props.href) {
            return (React.createElement("a", { className: this.getClassNames(), href: this.props.href, "uk-icon": this.props.options }));
        }
        else if (this.props.image) {
            return (React.createElement("span", { className: this.getClassNames(), style: { backgroundImage: "url(" + this.props.image + ")" }, "uk-icon": this.props.options }));
        }
        else {
            return (React.createElement("em", { className: this.getClassNames(), "uk-icon": this.props.options }));
        }
    };
...
var Alert = /** @class */ (function (_super) {
    ...
    Alert.prototype.render = function () {
        if (this.state.isClosed)
            return false;
        return (React.createElement("div", { className: this.setClassNames(), style: {
                overflow: 'hidden',
            ...
            this.props.isClosable ?
                React.createElement("a", { className: "uk-alert-close", onClick: this.handleClose.bind(this) },
                    React.createElement(Icon, { options: "close" }))
                :
                    null,
...
var Article = /** @class */ (function (_super) {
    ...
    Article.prototype.render = function () {
        return (React.createElement("article", { className: "\n                uk-article\n                " + setClassNames(this.props) + "\n            " },
            React.createElement("h1", { className: "uk-article-title" }, this.props.title),
            this.props.meta ? React.createElement("p", { className: "uk-article-meta" }, this.props.meta) : '',
            this.props.lead ? React.createElement("p", { className: "uk-text-lead" }, this.props.lead) : '',
...
var Badge = /** @class */ (function (_super) {
    ...
    Badge.prototype.render = function () {
        return (React.createElement("span", { className: "uk-badge" }, this.props.count));
    };
    return Badge;
}(React.Component));
...
var Breadcrumb = /** @class */ (function (_super) {
    ...
    Breadcrumb.prototype.render = function () {
        return (React.createElement("ul", { className: "uk-breadcrumb" }, this.props.children));
    };
    return Breadcrumb;
}(React.Component));
...
var Button = /** @class */ (function (_super) {
    ...
    Button.prototype.render = function () {
        return (this.isLink() ?
            React.createElement("a", { "uk-toggle": this.props.toggleOptions, href: this.props.href, onClick: this.props.onClick, className: this.setClassNames() }, this.props.children)
            :
                React.createElement("button", { "uk-toggle": this.props.toggleOptions, onClick: this.props.onClick, className: this.setClassNames() }, this.props.children));
    };
...
var CardBody = /** @class */ (function (_super) {
    ...
    CardBody.prototype.render = function () {
        return (React.createElement("div", { className: "uk-card-body" }, this.props.children));
    };
    return CardBody;
}(React.Component));
...
var CardFooter = /** @class */ (function (_super) {
    ...
    CardFooter.prototype.render = function () {
        return (React.createElement("div", { className: "uk-card-footer" }, this.props.children));
    };
    return CardFooter;
}(React.Component));
...
var CardHeader = /** @class */ (function (_super) {
    ...
    CardHeader.prototype.render = function () {
        return (React.createElement("div", { className: "uk-card-header" }, this.props.children));
    };
    return CardHeader;
}(React.Component));
...
var CardTitle = /** @class */ (function (_super) {
    ...
    CardTitle.prototype.render = function () {
        return (React.createElement("h3", { className: "uk-card-title" }, this.props.children));
    };
    return CardTitle;
}(React.Component));

var classNames$7 = require('classnames');
var Container = /** @class */ (function (_super) {
    ...
    Container.prototype.render = function () {
        return (React.createElement("div", { style: this.props.style ? this.props.style : null, className: this.setClassNames() }, this.props.children));
    };
...
var Cover = /** @class */ (function (_super) {
    ...
    Cover.prototype.render = function () {
        return (React.createElement("div", { className: "uk-cover-container" },
    ...
    Cover.prototype.renderBasedOnType = function () {
        if (this.props.type === 'image') {
            return (React.createElement("img", { src: this.props.src, alt: this.props.alt, width: this.props.width, height: this.props.height, "uk-cover": true }));
        }
        else if (this.props.type === 'video') {
            return (React.createElement("video", { autoPlay: this.props.autoPlay, loop: this.props.loop, muted: this.props.muted, playsinline: this.props.playsinline, width: this.props.width, height: this.props.height, "uk-cover": true },
                React.createElement("source", { src: this.props.src, type: this.props.type + "/" + this.props.videoFormat })));
        }
        else {
...
var Dropdown = /** @class */ (function (_super) {
    ...
    Dropdown.prototype.render = function () {
        return (React.createElement("div", { "uk-dropdown": this.props.options ? this.props.options : "" },
            React.createElement("ul", { className: "uk-nav uk-dropdown-nav" }, this.props.children)));
    };
    return Dropdown;
}(React.Component));

var classNames$8 = require('classnames');
...
var classNames$9 = require('classnames');
var Checkbox = /** @class */ (function (_super) {
    ...
    Checkbox.prototype.render = function () {
        return (React.createElement("input", { id: this.props.id, className: this.setClassNames(), type: "checkbox", name: this.props.name ? this.props.name : null, value: this.props.value, onChange: this.props.onChange, onBlur: this.props.onBlur, onFocus: this.props.onFocus }));
    };
...
var classNames$a = require('classnames');
var Fieldset = /** @class */ (function (_super) {
    ...
    Fieldset.prototype.render = function () {
        return (React.createElement("fieldset", { className: this.setClassNames() }, this.props.children));
    };
...
var classNames$b = require('classnames');
var Form = /** @class */ (function (_super) {
    ...
    Form.prototype.render = function () {
        return (React.createElement("div", { className: this.setClassNames(), "uk-form-custom": this.props.custom ? "" : null }, this.props.children));
    };
...
var classNames$c = require('classnames');
var Input = /** @class */ (function (_super) {
    ...
    Input.prototype.render = function () {
        return (React.createElement("input", { id: this.props.id, className: this.setClassNames(), type: "text", name: this.props.name ? this.props.name : null, value: this.props.value, onChange: this.props.onChange, onBlur: this.props.onBlur, onFocus: this.props.onFocus }));
    };
...
var classNames$d = require('classnames');
var InputContainer = /** @class */ (function (_super) {
    ...
    InputContainer.prototype.render = function () {
        return (React.createElement("div", { className: "uk-form-controls" }, this.props.children));
    };
    return InputContainer;
}(React.Component));

var classNames$e = require('classnames');
var Label = /** @class */ (function (_super) {
    ...
    Label.prototype.render = function () {
        return (React.createElement("label", { className: "uk-form-label", htmlFor: this.props.htmlFor }, this.props.children));
    };
    return Label;
}(React.Component));

var classNames$f = require('classnames');
var Legend = /** @class */ (function (_super) {
    ...
    Legend.prototype.render = function () {
        return (React.createElement("legend", { className: this.setClassNames() }, this.props.children));
    };
...
var classNames$g = require('classnames');
var Radio = /** @class */ (function (_super) {
    ...
    Radio.prototype.render = function () {
        return (React.createElement("input", { id: this.props.id, className: this.setClassNames(), type: "radio", name: this.props.name ? this.props.name : null, value: this.props.value, onChange: this.props.onChange, onBlur: this.props.onBlur, onFocus: this.props.onFocus }));
    };
...
var classNames$h = require('classnames');
var Range = /** @class */ (function (_super) {
    ...
    Range.prototype.render = function () {
        return (React.createElement("input", { id: this.props.id, className: this.setClassNames(), type: "range", name: this.props.name ? this.props.name : null, value: this.props.value, min: this.props.min, max: this.props.max, step: this.props.step, onChange: this.props.onChange, onBlur: this.props.onBlur, onFocus: this.props.onFocus }));
    };
...
var classNames$i = require('classnames');
var Select = /** @class */ (function (_super) {
    ...
    Select.prototype.render = function () {
        return (React.createElement("select", { id: this.props.id, className: this.setClassNames(), value: this.props.value, onChange: this.props.onChange }, this.props.children));
    };
...
var classNames$j = require('classnames');
...
var classNames$k = require('classnames');
var Textarea = /** @class */ (function (_super) {
    ...
    Textarea.prototype.render = function () {
        return (React.createElement("textarea", { className: this.setClassNames(), name: this.props.name ? this.props.name : null, placeholder: this.props.placeholder, onChange: this.props.onChange, onBlur: this.props.onBlur, onFocus: this.props.onFocus }, this.props.children));
    };
...
var Image = /** @class */ (function (_super) {
    ...
    Image.prototype.render = function () {
        return (React.createElement("img", { className: this.props.className, width: this.props.width, height: this.props.height, style: this.props.style, "data-src": this.props.src, "uk-img": this.props.options ? this.props.options : "" }));
    };
    return Image;
}(React.Component));
...
var Lightbox = /** @class */ (function (_super) {
    ...
    Lightbox.prototype.render = function () {
        return (React.createElement("div", { "uk-grid": true, "uk-lightbox": this.props.options ? this.props.options : "" }, this.props.children));
    };
    return Lightbox;
}(React.Component));
...
var LightboxItem = /** @class */ (function (_super) {
    ...
    LightboxItem.prototype.render = function () {
        return (React.createElement("a", { href: this.props.href, "data-caption": this.props.caption }, this.props.children));
    };
    return LightboxItem;
}(React.Component));
...
var Link = /** @class */ (function (_super) {
    ...
    Link.prototype.render = function () {
        return (React.createElement("a", { "uk-toggle": this.props.toggleOptions ? this.props.toggleOptions : null, href: this.props.href, className: "\n                    uk-link-" + linkType(this.props.type) + "\n                " }, this.props.children));
    };
    return Link;
}(React.Component));
...
var List = /** @class */ (function (_super) {
    ...
    List.prototype.render = function () {
        return (React.createElement("ul", { className: "uk-list " + this.setType() }, this.props.children));
    };
...
var Margin = /** @class */ (function (_super) {
    ...
    Margin.prototype.render = function () {
        return (React.createElement("div", { "uk-margin": this.props.dynamicWrapping, className: this.setClassNames() }, this.props.children));
    };
...
var classNames$l = require('classnames');
var Nav = /** @class */ (function (_super) {
    ...
    Nav.prototype.render = function () {
        return (React.createElement("ul", { className: "" + this.setClassNames(), style: this.props.style, "uk-nav": this.props.options ? this.props.options : "" }, this.props.children));
    };
...
var classNames$m = require('classnames');
var NavItem = /** @class */ (function (_super) {
    ...
    NavItem.prototype.render = function () {
        return (React.createElement("li", { className: "" + this.setClassNames() }, this.props.children));
    };
...
var Navbar = /** @class */ (function (_super) {
    ...
    Navbar.prototype.render = function () {
        return (React.createElement("div", { className: "" + this.setAlign() },
            React.createElement("ul", { className: "uk-navbar-nav" }, this.props.children)));
    };
...
var classNames$n = require('classnames');
var NavbarContainer = /** @class */ (function (_super) {
    ...
    NavbarContainer.prototype.render = function () {
        return (React.createElement("div", null,
            ...
            this.props.dropbar ?
                React.createElement("div", { className: "uk-navbar-dropbar" })
                :
                    ''));
    };
...
var NavbarDropdown = /** @class */ (function (_super) {
    ...
    NavbarDropdown.prototype.render = function () {
        return (React.createElement("div", { className: "uk-navbar-dropdown" },
            React.createElement("ul", { className: "uk-nav uk-navbar-dropdown-nav" }, this.props.children)));
    };
...
var NavbarSticky = /** @class */ (function (_super) {
    ...
    NavbarSticky.prototype.render = function () {
        return (React.createElement("div", { "uk-sticky": "\n                sel-target: .uk-navbar-container;\n                cls-active: uk-navbar-sticky;\n                " + (this.props.options ? this.props.options : '') + "\n            " }, this.props.children));
    };
    return NavbarSticky;
}(React.Component));
...
var Offcanvas = /** @class */ (function (_super) {
    ...
    Offcanvas.prototype.render = function () {
        return (React.createElement("div", { id: this.props.id, "uk-offcanvas": this.props.options ? this.props.options : "" },
            React.createElement("div", { className: "uk-offcanvas-bar" }, this.props.children)));
    };
    return Offcanvas;
}(React.Component));
...
var OffcanvasContainer = /** @class */ (function (_super) {
    ...
    OffcanvasContainer.prototype.render = function () {
        return (React.createElement("div", { className: "uk-offcanvas-content" }, this.props.children));
    };
...
var Overlay = /** @class */ (function (_super) {
    ...
    Overlay.prototype.render = function () {
        return (React.createElement("div", { className: "uk-overlay " + this.setPosition() }, this.props.showIcon ? React.createElement("span", { "uk-overlay-icon": true }) : ""));
    };
...
var classNames$o = require('classnames');
...
var Parallax = /** @class */ (function (_super) {
    ...
    Parallax.prototype.render = function () {
        return (React.createElement("div", null, this.applyParallaxFiltersToChild()));
    };
    Parallax.prototype.applyParallaxFiltersToChild = function () {
        ...
        return React.Children.map(this.props.children, function (child, idx) {
            if (idx > 0)
                return child;
            return React.cloneElement(child, { 'uk-parallax': _this.props.options });
        });
    };
    return Parallax;
}(React.Component));
...
var Progress = /** @class */ (function (_super) {
    ...
    Progress.prototype.render = function () {
        return (React.createElement("progress", { className: "uk-progress", value: this.state.value, max: this.props.max }));
    };
    return Progress;
}(React.Component));
...
var Scrollspy = /** @class */ (function (_super) {
    ...
    Scrollspy.prototype.render = function () {
        return (React.createElement("div", { "uk-scrollspy": this.props.options }, this.props.children));
    };
    return Scrollspy;
}(React.Component));

var classNames$p = require('classnames');
...
var classNames$q = require('classnames');
var Sidebar = /** @class */ (function (_super) {
    ...
    Sidebar.prototype.render = function () {
        return (React.createElement("div", { style: this.props.style, className: this.setClassNames() }, this.props.children));
    };
...
var Slideshow = /** @class */ (function (_super) {
    ...
    Slideshow.prototype.render = function () {
        return (React.createElement("div", { "uk-slideshow": this.props.options ? this.props.options : "" }, this.setNavigation()));
    };
    Slideshow.prototype.setNavigation = function () {
        if (this.props.navigation) {
            return (React.createElement("div", { className: "uk-position-relative uk-visible-toggle " + this.setNavigationStyle() },
                React.createElement("ul", { className: "uk-slideshow-items" }, this.props.children),
            ...
            return (React.createElement("ul", { className: "uk-slideshow-items" }, this.props.children));
        }
    };
...
var SlideshowItem = /** @class */ (function (_super) {
    ...
    SlideshowItem.prototype.render = function () {
        return (React.createElement("li", null, this.renderBasedOnType()));
    };
    SlideshowItem.prototype.renderBasedOnType = function () {
        if (this.props.type === 'image') {
            return (React.createElement("img", { src: this.props.src, alt: this.props.alt, "uk-cover": "" }));
        }
        else if (this.props.type === 'video') {
            return (React.createElement("video", { autoPlay: this.props.autoPlay, loop: this.props.loop, muted: this.props.muted, playsinline: this.props.playsinline, "uk-cover": "" },
                React.createElement("source", { src: this.props.src, type: this.props.type + "/" + this.props.videoFormat })));
        }
        else {
            console.error('Type property on cover component must be either video or image');
...
var TabContainer = /** @class */ (function (_super) {
    ...
    TabContainer.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement("ul", { "uk-tab": this.props.options ? this.props.options : "" }, this.renderChildren('tab')),
            React.createElement("ul", { id: this.props.id ? this.props.id : "", className: "uk-switcher" }, this.renderChildren('tab-content'))));
    };
...
var classNames$r = require('classnames');
var Table = /** @class */ (function (_super) {
    ...
    Table.prototype.render = function () {
        return (React.createElement("table", { className: "uk-table " + this.setClassNames() }, this.props.children));
    };
