...
function Dropdown(props) {
    return (React.createElement("div", { id: props.id ? props.id : null, className: `${setClassNames(props)}`, "data-uk-dropdown": props.options ? props.options : '' },
        React.createElement("ul", { style: props.style ? props.style : null, className: `uk-nav uk-dropdown-nav` }, props.children)));
}
