...
var Article = /** @class */ (function(_super) {
  ...
  Article.prototype.render = function() {
    return createElement(
      ...
      this.props.meta
        ? createElement("p", { className: "uk-article-meta" }, this.props.meta)
        : "",
      this.props.lead
        ? createElement("p", { className: "uk-text-lead" }, this.props.lead)
        : "",
...
var Flex = /** @class */ (function(_super) {
  ...
  Flex.prototype.setClassNames = function() {
    var _a;
    var alignments = this.props.alignment
      ? this.props.alignment.split(" ")
      : [];
    return classNames$7(
      ((_a = {}),
...
var NavbarSticky = /** @class */ (function(_super) {
  ...
  NavbarSticky.prototype.validateIdProp = function() {
    if (!this.props.id) {
      console.error(
        "ID property is required to register to Navbar Sticky events"
      );
    }
  };
  return NavbarSticky;
...
var Overlay = /** @class */ (function(_super) {
  ...
  Overlay.prototype.render = function() {
    return createElement(
      ...
      this.props.showIcon
        ? createElement("span", { "uk-overlay-icon": true })
        : null
    );
  };
