...
var Accordion = /** @class */ (function (_super) {
    ...
    Accordion.prototype.render = function () {
        return (createElement("ul", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: setClassNames(this.props), "data-uk-accordion": this.props.options ? this.props.options : "" }, this.props.children));
    };
    return Accordion;
}(Component));
...
var AccordionItem = /** @class */ (function (_super) {
    ...
    AccordionItem.prototype.render = function () {
        var _a = this.props, title = _a.title, content = _a.content, rest = __rest(_a, ["title", "content"]);
        return (createElement("li", __assign({}, rest),
...
var Icon = /** @class */ (function (_super) {
    ...
    Icon.prototype.renderIconType = function () {
        if (this.props.href) {
            return (createElement("a", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: this.getClassNames(), href: this.props.href, "uk-icon": this.props.options }));
        }
        else if (this.props.image) {
            return (createElement("span", { id: this.props.id ? this.props.id : null, className: this.getClassNames(), style: __assign({ backgroundImage: "url(" + this.props.image + ")" }, this.props.style), "uk-icon": this.props.options }));
        }
        else {
            return (createElement("em", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: this.getClassNames(), "uk-icon": this.props.options }));
        }
    };
    Icon.prototype.getClassNames = function () {
        var _a;
        return classNames$2((_a = {},
            _a["uk-icon"] = true,
...
var Alert = /** @class */ (function (_super) {
    ...
    Alert.prototype.render = function () {
        if (this.state.isClosed)
            return false;
        return (createElement("div", { id: this.props.id ? this.props.id : null, className: this.setClassNames(), style: __assign({ overflow: 'hidden', transition: 'height 0.5s ease-in-out, opacity 0.3s ease-in-out', height: !this.state.isOpen ? 0 : 'auto', opacity: !this.state.isOpen ? 0 : 1 }, this.props.style) },
    ...
    Alert.prototype.setClassNames = function () {
        var _a;
        return classNames$3('uk-alert', (_a = {},
...
var Article = /** @class */ (function (_super) {
    ...
    Article.prototype.render = function () {
        return (createElement("article", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: "\n                    uk-article\n                    " + setClassNames(this.props) + "\n                " },
...
var Badge = /** @class */ (function (_super) {
    ...
    Badge.prototype.render = function () {
        return (createElement("span", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: "uk-badge " + setClassNames(this.props) }, this.props.count));
    };
    return Badge;
}(Component));
...
var Breadcrumb = /** @class */ (function (_super) {
    ...
    Breadcrumb.prototype.render = function () {
        return (createElement("ul", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: "uk-breadcrumb " + setClassNames(this.props) }, this.props.children));
    };
    return Breadcrumb;
}(Component));
...
var Button = /** @class */ (function (_super) {
    ...
    Button.prototype.render = function () {
        return (this.isLink() ?
            createElement("a", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, "uk-toggle": this.props.toggleOptions, href: this.props.href, onClick: this.props.onClick, className: this.setClassNames() }, this.props.children)
            :
                createElement("button", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, "uk-toggle": this.props.toggleOptions, onClick: this.props.onClick, className: this.setClassNames() }, this.props.children));
    };
    ...
    Button.prototype.setClassNames = function () {
        var _a;
        return classNames$4('uk-button', (_a = {},
...
var Card = /** @class */ (function (_super) {
    ...
    Card.prototype.render = function () {
        return (createElement("div", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: this.setClassNames() }, this.props.children));
    };
    Card.prototype.setClassNames = function () {
        var _a;
        return classNames$5('uk-card', (_a = {},
...
var CardBody = /** @class */ (function (_super) {
    ...
    CardBody.prototype.render = function () {
        return (createElement("div", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: "uk-card-body " + setClassNames(this.props) }, this.props.children));
    };
    return CardBody;
}(Component));
...
var CardFooter = /** @class */ (function (_super) {
    ...
    CardFooter.prototype.render = function () {
        return (createElement("div", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: "uk-card-footer " + setClassNames(this.props) }, this.props.children));
    };
    return CardFooter;
}(Component));
...
var CardHeader = /** @class */ (function (_super) {
    ...
    CardHeader.prototype.render = function () {
        return (createElement("div", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: "uk-card-header " + setClassNames(this.props) }, this.props.children));
    };
    return CardHeader;
}(Component));
...
var CardTitle = /** @class */ (function (_super) {
    ...
    CardTitle.prototype.render = function () {
        return (createElement("h3", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: "uk-card-title " + setClassNames(this.props) }, this.props.children));
    };
    return CardTitle;
}(Component));
...
var Cover = /** @class */ (function (_super) {
    ...
    Cover.prototype.render = function () {
        return (createElement("div", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: "uk-cover-container " + setClassNames(this.props) },
...
var Dark = /** @class */ (function (_super) {
    ...
    Dark.prototype.render = function () {
        return (createElement("div", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: "uk-dark " + setClassNames(this.props) }, this.props.children));
    };
    return Dark;
}(Component));
...
var Dropdown = /** @class */ (function (_super) {
    ...
    Dropdown.prototype.render = function () {
        return (createElement("div", { id: this.props.id ? this.props.id : null, className: "" + setClassNames(this.props), "uk-dropdown": this.props.options ? this.props.options : "" },
            createElement("ul", { style: this.props.style ? this.props.style : null, className: "uk-nav uk-dropdown-nav" }, this.props.children)));
    };
    return Dropdown;
}(Component));
...
var Flex = /** @class */ (function (_super) {
    ...
    Flex.prototype.render = function () {
        return (createElement("div", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: "uk-flex " + this.setClassNames() }, this.props.children));
    };
...
var Checkbox = /** @class */ (function (_super) {
    ...
    Checkbox.prototype.render = function () {
        return (createElement("input", { id: this.props.id, placeholder: this.props.placeholder ? this.props.placeholder : null, style: this.props.style ? this.props.style : null, className: this.setClassNames(), type: "checkbox", name: this.props.name ? this.props.name : null, value: this.props.value, onChange: this.props.onChange, onBlur: this.props.onBlur, onFocus: this.props.onFocus }));
    };
...
var Fieldset = /** @class */ (function (_super) {
    ...
    Fieldset.prototype.render = function () {
        return (createElement("fieldset", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: this.setClassNames() }, this.props.children));
    };
...
var Form = /** @class */ (function (_super) {
    ...
    Form.prototype.render = function () {
        return (createElement("div", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: this.setClassNames(), "uk-form-custom": this.props.custom ? "" : null }, this.props.children));
    };
...
var Input = /** @class */ (function (_super) {
    ...
    Input.prototype.render = function () {
        return (createElement("input", { id: this.props.id, placeholder: this.props.placeholder ? this.props.placeholder : null, style: this.props.style ? this.props.style : null, className: this.setClassNames(), type: "text", name: this.props.name ? this.props.name : null, value: this.props.value, onChange: this.props.onChange, onBlur: this.props.onBlur, onFocus: this.props.onFocus }));
    };
...
var InputContainer = /** @class */ (function (_super) {
    ...
    InputContainer.prototype.render = function () {
        return (createElement("div", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: "uk-form-controls " + setClassNames(this.props) }, this.props.children));
    };
...
var FormLabel = /** @class */ (function (_super) {
    ...
    FormLabel.prototype.render = function () {
        return (createElement("label", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: "" + setClassNames(this.props), htmlFor: this.props.htmlFor }, this.props.children));
    };
    return FormLabel;
}(Component));
...
var Legend = /** @class */ (function (_super) {
    ...
    Legend.prototype.render = function () {
        return (createElement("legend", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: this.setClassNames() }, this.props.children));
    };
    Legend.prototype.setClassNames = function () {
        var _a;
        return classNames$e((_a = {},
            _a["uk-legend"] = true,
            _a["" + setClassNames(this.props)] = true,
            _a));
    };
...
var Radio = /** @class */ (function (_super) {
    ...
    Radio.prototype.render = function () {
        return (createElement("input", { id: this.props.id, placeholder: this.props.placeholder ? this.props.placeholder : null, style: this.props.style ? this.props.style : null, className: this.setClassNames(), type: "radio", name: this.props.name ? this.props.name : null, value: this.props.value, onChange: this.props.onChange, onBlur: this.props.onBlur, onFocus: this.props.onFocus }));
    };
...
var Range = /** @class */ (function (_super) {
    ...
    Range.prototype.render = function () {
        return (createElement("input", { id: this.props.id, placeholder: this.props.placeholder ? this.props.placeholder : null, style: this.props.style ? this.props.style : null, className: this.setClassNames(), type: "range", name: this.props.name ? this.props.name : null, value: this.props.value, min: this.props.min, max: this.props.max, step: this.props.step, onChange: this.props.onChange, onBlur: this.props.onBlur, onFocus: this.props.onFocus }));
    };
...
var Select = /** @class */ (function (_super) {
    ...
    Select.prototype.render = function () {
        return (createElement("select", { id: this.props.id, placeholder: this.props.placeholder ? this.props.placeholder : null, style: this.props.style ? this.props.style : null, className: this.setClassNames(), value: this.props.value, onChange: this.props.onChange }, this.props.children));
    };
...
var SelectOption = /** @class */ (function (_super) {
    ...
    SelectOption.prototype.render = function () {
        return (createElement("option", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: "" + setClassNames(this.props), value: this.props.value }, this.props.children));
    };
    return SelectOption;
}(Component));
...
var Textarea = /** @class */ (function (_super) {
    ...
    Textarea.prototype.render = function () {
        return (createElement("textarea", { id: this.props.id ? this.props.id : null, placeholder: this.props.placeholder ? this.props.placeholder : null, style: this.props.style ? this.props.style : null, className: this.setClassNames(), name: this.props.name ? this.props.name : null, onChange: this.props.onChange, onBlur: this.props.onBlur, onFocus: this.props.onFocus }, this.props.children));
    };
    Textarea.prototype.setClassNames = function () {
        var _a;
        return classNames$j((_a = {},
            _a["uk-textarea"] = true,
            _a["uk-form-" + this.props.color] = !!this.props.color,
            _a["uk-form-" + this.props.width] = !!this.props.width,
            _a["uk-form-" + this.props.layout] = !!this.props.layout,
...
var Grid = /** @class */ (function (_super) {
    ...
    Grid.prototype.render = function () {
        return (createElement("div", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: "" + this.setClassNames(), "uk-grid": this.props.options ? this.props.options : "" }, this.props.children));
    };
...
var Image = /** @class */ (function (_super) {
    ...
    Image.prototype.render = function () {
        return (createElement("img", { id: this.props.id ? this.props.id : null, className: this.props.className, width: this.props.width, height: this.props.height, style: this.props.style ? this.props.style : null, "data-src": this.props.src, "uk-img": this.props.options ? this.props.options : "" }));
    };
    return Image;
}(Component));
...
var Label = /** @class */ (function (_super) {
    ...
    Label.prototype.render = function () {
        return (createElement("div", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: "" + setClassNames(this.props) }, this.props.content));
    };
    Label.prototype.setClassNames = function () {
        var _a;
        return classNames$m('uk-label', (_a = {},
            _a["uk-label-" + this.props.color] = !!this.props.color,
            _a));
    };
    return Label;
}(Component));
...
var Light = /** @class */ (function (_super) {
    ...
    Light.prototype.render = function () {
        return (createElement("div", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: "uk-light " + setClassNames(this.props) }, this.props.children));
    };
    return Light;
}(Component));
...
var Lightbox = /** @class */ (function (_super) {
    ...
    Lightbox.prototype.render = function () {
        return (createElement("div", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: setClassNames(this.props), "uk-lightbox": this.props.options ? this.props.options : "" }, this.props.children));
    };
    return Lightbox;
}(Component));
...
var LightboxItem = /** @class */ (function (_super) {
    ...
    LightboxItem.prototype.render = function () {
        return (createElement("a", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: setClassNames(this.props), href: this.props.href, "data-caption": this.props.caption }, this.props.children));
    };
    return LightboxItem;
}(Component));
...
var Link = /** @class */ (function (_super) {
    ...
    Link.prototype.render = function () {
        return (createElement("a", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, "uk-toggle": this.props.toggleOptions ? this.props.toggleOptions : null, href: this.props.href, className: "" + this.setClassNames() }, this.props.children));
    };
...
var List = /** @class */ (function (_super) {
    ...
    List.prototype.render = function () {
        return (createElement("ul", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: "" + this.setClassNames() }, this.props.children));
    };
    List.prototype.setClassNames = function () {
        var _a;
        return classNames$o('uk-list', (_a = {},
            _a["uk-link-" + this.props.type] = !!this.props.type,
            _a["" + setClassNames(this.props)] = true,
            _a));
    };
...
var ListItem = /** @class */ (function (_super) {
    ...
    ListItem.prototype.render = function () {
        return (createElement("li", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: setClassNames(this.props) }, this.props.children));
    };
    return ListItem;
}(Component));
...
var Margin = /** @class */ (function (_super) {
    ...
    Margin.prototype.render = function () {
        return (createElement("div", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, "uk-margin": this.props.dynamicWrapping, className: this.setClassNames() }, this.props.children));
    };
    Margin.prototype.setClassNames = function () {
        ...
        return classNames$p(classString, (_a = {},
            _a["" + setClassNames(this.props)] = true,
            _a));
    };
    return Margin;
...
var Nav = /** @class */ (function (_super) {
    ...
    Nav.prototype.render = function () {
        return (createElement("ul", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: "" + this.setClassNames(), "uk-nav": this.props.options ? this.props.options : "" }, this.props.children));
    };
...
var NavItem = /** @class */ (function (_super) {
    ...
    NavItem.prototype.render = function () {
        return (createElement("li", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: "" + this.setClassNames() }, this.props.children));
    };
...
var Navbar = /** @class */ (function (_super) {
    ...
    Navbar.prototype.render = function () {
        return (createElement("div", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: "" + this.setClassNames() },
            createElement("ul", { className: "uk-navbar-nav" }, this.props.children)));
    };
    Navbar.prototype.setClassNames = function () {
        var _a;
        return classNames$s((_a = {},
...
var NavbarContainer = /** @class */ (function (_super) {
    ...
    NavbarContainer.prototype.render = function () {
        return (createElement("div", null,
            createElement("nav", { id: this.props.id ? this.props.id : null, className: "" + this.setClassNames(), style: this.props.style ? this.props.style : null, "uk-navbar": this.props.options ? this.props.options : "" }, this.props.children),
            this.props.dropbar ?
                createElement("div", { className: "uk-navbar-dropbar" }) : null));
    };
    NavbarContainer.prototype.setClassNames = function () {
        var _a;
        return classNames$t('uk-navbar-container', (_a = {},
...
var NavbarDropdown = /** @class */ (function (_super) {
    ...
    NavbarDropdown.prototype.render = function () {
        return (createElement("div", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: "uk-navbar-dropdown " + setClassNames(this.props) },
...
var NavbarSticky = /** @class */ (function (_super) {
    ...
    NavbarSticky.prototype.render = function () {
        return (createElement("div", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: "" + setClassNames(this.props), "uk-sticky": "\n                    sel-target: .uk-navbar-container;\n                    cls-active: uk-navbar-sticky;\n                    " + (this.props.options ? this.props.options : '') + "\n            " }, this.props.children));
    };
...
var Offcanvas = /** @class */ (function (_super) {
    ...
    Offcanvas.prototype.render = function () {
        return (createElement("div", { id: this.props.id, style: this.props.style ? this.props.style : null, className: "" + setClassNames(this.props), "uk-offcanvas": this.props.options ? this.props.options : "" },
...
var OffcanvasContainer = /** @class */ (function (_super) {
    ...
    OffcanvasContainer.prototype.render = function () {
        return (createElement("div", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: "uk-offcanvas-content " + setClassNames(this.props) }, this.props.children));
    };
...
var Overlay = /** @class */ (function (_super) {
    ...
    Overlay.prototype.render = function () {
        return (createElement("div", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: "" + this.setClassNames() }, this.props.showIcon ? createElement("span", { "uk-overlay-icon": true }) : null));
    };
    Overlay.prototype.setClassNames = function () {
        var _a;
        return classNames$u('uk-overlay', (_a = {},
...
var Panel = /** @class */ (function (_super) {
    ...
    Panel.prototype.setClassNames = function () {
        var _a;
        return classNames$v('uk-panel', (_a = {},
...
var Parallax = /** @class */ (function (_super) {
    ...
    Parallax.prototype.render = function () {
        return (createElement("div", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: "" + setClassNames(this.props) }, this.applyParallaxFiltersToChild()));
    };
...
var Progress = /** @class */ (function (_super) {
    ...
    Progress.prototype.render = function () {
        return (createElement("progress", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: "" + this.setClassNames(), value: this.state.value, max: this.props.max }));
    };
    Progress.prototype.setClassNames = function () {
        var _a;
        return classNames$w('uk-progress', (_a = {},
            _a["" + setClassNames(this.props)] = true,
            _a));
    };
    return Progress;
...
var Scrollspy = /** @class */ (function (_super) {
    ...
    Scrollspy.prototype.render = function () {
        return (createElement("div", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: "" + setClassNames(this.props), "uk-scrollspy": this.props.options ? this.props.options : "" }, this.props.children));
    };
    return Scrollspy;
}(Component));
...
var Slideshow = /** @class */ (function (_super) {
    ...
    Slideshow.prototype.render = function () {
        return (createElement("div", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: "" + setClassNames(this.props), "uk-slideshow": this.props.options ? this.props.options : "" }, this.setNavigation()));
    };
...
var SlideshowItem = /** @class */ (function (_super) {
    ...
    SlideshowItem.prototype.render = function () {
        return (createElement("li", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: "" + setClassNames(this.props) }, this.renderBasedOnType()));
    };
...
var Tab = /** @class */ (function (_super) {
    ...
    Tab.prototype.render = function () {
        return (createElement("li", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: setClassNames(this.props) },
...
var TabContainer = /** @class */ (function (_super) {
    ...
    TabContainer.prototype.render = function () {
        return (createElement("div", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: setClassNames(this.props) },
...
var Table = /** @class */ (function (_super) {
    ...
    Table.prototype.render = function () {
        return (createElement("table", { id: this.props.id ? this.props.id : null, style: this.props.style ? this.props.style : null, className: "" + this.setClassNames() }, this.props.children));
    };
